...
// const About = forwardRef(({ value, onChange }, ref) => {
//   return (
//     <div style={{ height: "100vh", backgroundColor: "red" }} ref={ref}>
//       // wzium //{" "}
//     </div>
//   )
// })
    ...
    <Wrapper ref={aboutRef}>
      <TextWrapper>
        ...
        <p>
          ...
          commercial experience behind me, and I am constantly improving my skills as
          a developer.
        </p>
        <p>
          In my free time, I also deal with designing, drawing, watching automotive
          curiosities, exercising or immersing himself in a computer game or series.
        </p>
      </TextWrapper>
      <img src={myPicture} />
    </Wrapper>
